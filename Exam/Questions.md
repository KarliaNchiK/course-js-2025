...
47. Какие способы подключения Vue существуют?
...
58. Какие существуют подходы (API) для разработки внутри Vue? Какой подход более приоритетный и почему?
...
67. Что такое ссылки на элементы шаблона в компонентах Vue? Для чего используются?
68. В чем проблема совместного использования директив "v-for" и "v-if" на одном теге? Как избежать этого?
69. Что такое динамические компоненты во Vue? Зачем они нужны? Приведите пример
70. Каким образом можно реализовать анимацию во Vue?
71. Что такое "инъекция зависимостей" во Vue? Зачем может использоваться?
72. Чем вредно дублирование кода? Какие есть способы композиции логики?
...
75. Что такое "State Manager"? В каких случаях его целесообразно использовать?
76. В чем ключевые отличия Pinia от Vuex? Почему Pinia стал официальной рекомендацией для Vue 3?
77. Как инициализировать хранилище Pinia и подключить его к Vue ? 
78. Опишите, что может содержать хранилище, как работать с этими данными внутри Vue компонент ?
79. В чем суть модульной системы работы с Pinia? Какие проблемы она решает?
80. Кто такое "персисторы" в контексте работы во Pinia? Зачем они нужны?
...
92. Что такое и для чего нужен "vite"? Какие проблемы он решает?
93. Опишите (кратко) логику работы сборщиков фронтенда на примере "vite"
