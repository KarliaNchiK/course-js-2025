<template>
    <div class="quotes">
        ...
        <input class="form-control form-control-lg" type="text" v-model="searchText" placeholder="Жизнь" />

        <div v-for="quote in quotes" :key="quote.id" class="quotes__quote-block" v-show="getVisibility(quote.text)">
