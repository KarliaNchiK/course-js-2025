<template><div class="quotes">
  ...
  <input
      ...
      placeholder="Жизнь"
  />
  <div class="quotes__container"><div
  ...
  ><div
      ...
      v-replace="{text: quote.text, search: searchText}"
  ></div><div class="quotes__quote-author">
    (c) {{ quote.author }}</div></div></div>
</div></template>
